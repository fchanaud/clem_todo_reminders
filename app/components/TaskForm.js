    ...
    <form onSubmit={handleSubmit} className="p-4 space-y-4">
      <div>
        ...
        <input
          ...
          required
          className="form-input mt-1 block w-full rounded-lg border-gray-300 bg-white py-2 px-3 text-gray-900 shadow-sm focus:border-primary-500 focus:ring-primary-500"
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <div>
          <label htmlFor="dueHour" className="block text-sm font-medium text-gray-700 mb-1">
            Hour
          </label>
          <select
            id="dueHour"
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="flex items-end">
          <div className="flex items-center space-x-2">
            ...
            />
            <label htmlFor="useSingleReminder" className="text-sm font-medium text-gray-700">
              Single reminder
            </label>
          </div>
        </div>
