...
task_data = {
    "id": task_id,
    "title": "PAST Test Pushover Notification",
...
# Create a reminder for 5 minutes in the PAST to ensure it's picked up immediately
...
print(f"\nTest task '{task_data['title']}' created with a reminder due at {reminder_time.strftime('%H:%M:%S')} (PAST)")
print(f"The check-reminders endpoint should detect this reminder immediately")
